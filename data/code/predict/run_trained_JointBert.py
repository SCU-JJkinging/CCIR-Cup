...
from data.code.model.JointBertModel import JointBertModel
...
if __name__ == "__main__":
    ...
    model = JointBertModel('../../user_data/pretrained_model/ernie',
                           ...
                           slot_tag_size,
                           device).to(device)
    checkpoint = torch.load('../../user_data/output_model/JointBert/trained_model/bert_model_best.pth.tar',
                            map_location='cpu')
    ...
    target_path = '../../user_data/tmp_result/result_bert_post.json'
